...
// models loader ------------------------------------------------
// EXPLAIN: instatiating gltf loader
...
const boxMesh2Tweaks = gui.addFolder('box Mesh 2');
...
async function init() {
	...
	// A. loading model
	// EXPLAIN: here is our duck model, we are loading binary
	...
	scene.add(sphereMesh1, boxMesh2, sphereMesh3, floorMesh);
	...
	sphereMesh1Tweaks
		...
		.min(-5)
		.max(5);
	boxMesh2Tweaks.add(boxMesh2, 'castShadow');
	boxMesh2Tweaks
		.add(boxMesh2.position, 'x')
		.step(0.001)
		.name('position.x')
		.min(-5)
		.max(5);
	boxMesh2Tweaks
		.add(boxMesh2.position, 'y')
		.step(0.001)
		.name('position.y')
		.min(0)
		.max(5);
	boxMesh2Tweaks
		.add(boxMesh2.position, 'z')
		.step(0.001)
		.name('position.z')
		.min(-5)
		.max(5);
	...
	function tick(timestamp: number) {
		...
		boxMesh2.position.y = Math.sin(elapsedTime * 0.8) * 1.5;
		sphereMesh3.position.y = Math.sin(elapsedTime * 1.4) * 1.5;

		//
		raycaster.setFromCamera(mouse, camera);

		// EXPLAIN: let's do model intersects right here, before
		// code from previous lessons related to raycaster
		const modelIntersects = raycaster.intersectObject(
			duckModel.scene,
		);

		// EXPLAIN: as you move cursor and you pierce the model
		// array that is being printed should have object
		// console.log(modelIntersects);

		// EXPLAIN: updating the scale
	...
	// // // // // // // // // // // // // // // // // // // // // //
	// // // // // // // // // // // // // // // // // // // // // //
	// CLICK   MOUSEMOVE   TOGGLE GUI    RESIZE       FULL SCREEN
	// // // // // // // // // // // // // // // // // // // // // //
	// // // // // // // // // // // // // // // // // // // // // //
	// // // // // // // // // // // // // // // // // // // // // //
	...
	window.addEventListener('click', (e) => {
		...
		if (currentIntersect) {
			...
			switch (currentIntersect.object) {
				case sphereMesh1:
					// console.log('clicked on intersected 1');
					currentIntersect.object.position.x += 0.04;

					break;
				case boxMesh2:
					currentIntersect.object.rotation.y += Math.PI / 3;
					// console.log('clicked on intersected 2');

					break;

				case sphereMesh3:
					// console.log('clicked on intersected 3');
