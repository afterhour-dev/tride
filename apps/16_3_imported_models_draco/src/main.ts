...
// EXPLAIN: we instatiate DRACOLoader
const dracoLoader = new DRACOLoader();
// EXPLAIN: provide the path of the folder
// where is our draco decoder; it would work without it
...
// EXPLAIN: we add dracoLoader to our GLTFLoader;
// which options of these are better. I tried both and it worked
...
async function init() {
	...
	// EXPLAIN: loading Duck model again but with draco;
	// you would get an error if you would't use
	// DracoLoader
