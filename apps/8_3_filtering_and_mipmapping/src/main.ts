...
// EXPLAIN: first test with door texture
/* const colorMap = textureLoader.load(
	'/textures/wooden_door/Door_Wood_001_basecolor.jpg',
); */
// EXPLAIN: than test it with this checkerboard texture
// in case when we were testing minification filter
// EXPLAIN: I didn't have the same result as from exmple of the
// app I was following in building this project
// when I was moving camera and zooming out parts of box were white
/* const colorMap = textureLoader.load(
	'/textures/checkerboard-1024x1024.png',
); */
// EXPLAIN: for testing magnification filter
...
async function init() {
	...
	// EXPLAIN: test on your screen and you'll get
	// It might be better, it may not, depends on visual result you want
	// for your project
	// pixel should be more sharp but also glitchy
	colorMap.minFilter = THREE.NearestFilter;

	// EXPLAIN: magnification filter
	// EXPLAIN: we don't need mip mapping for this, we are allowed to deactivate it
