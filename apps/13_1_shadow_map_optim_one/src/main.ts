...
async function init() {
	...
	// EXPLAIN: DirectionalLightShadow instance
	console.log(directionalLight.shadow);

	// EXPLAIN: shadow.camera here, and why it is
	// OrthographicCamera instance
	console.log(directionalLight.shadow.camera);

	// EXPLAIN: render size which we can set through mapSize property, a Vector2;
	// values should be the same and power of 2 for the mipmapping (explain why?)
	directionalLight.shadow.mapSize.width = 1024;
	directionalLight.shadow.mapSize.height = 1024;
	// EXPLAIN: near and far, especially good to see when tweaking with gui
	// with visible directional light shadow camera helper
	directionalLight.shadow.camera.near = 1;
	directionalLight.shadow.camera.far = 6;
	// EXPLAIN: amplitude (left right bottom top)
	...
	sphereTweaks
		...
		.max(5);
	// // // // // // // // // // // // // // // // // // //
	// EXPLAIN: all the tweaks that are shadow related first
	// there are more near the place where I instatiated shadow camera helper
	...
	// // // // // // // // //
	// EXPLAIN: directionalLight shadow camera helper
	...
	// EXPLAIN: next near and far tweaks
	shadowTweaks
		...
		.step(0.001)
		.onChange(() => {
			// EXPLAIN: why we needed to do these two updates here
	...
	// EXPLAIN: top right bottom left tweaks
	shadowTweaks
