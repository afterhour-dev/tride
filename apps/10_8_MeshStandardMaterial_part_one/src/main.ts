...
async function init() {
	...
	// EXPLAIN: our material requires light (we have two, point and ambient)
  ...
  */
	...
	*/
	...
	// EXPLAIN: next properties (was tweaking them with gui to see how it will look)
	...
	// EXPLAIN: optiong out of using
	// window.requestAnimationFrame(tick);
	// using setAnimationLoop instead
	...
	function tick(timestamp: number) {
		...
		// EXPLAIN: Ok, this might be unneccessary
		// coomenting it out because maybe is
		// already called under the hood
		// window.requestAnimationFrame(tick);
	}
}
