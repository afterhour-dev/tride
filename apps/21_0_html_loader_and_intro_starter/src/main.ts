...
async function init() {
	...
	// EXPLAIN: error happening in latest version of three
	// if I set this (don't know if it's related to version anyway
	// otr I made mismatch)
	// environmentMapAbandonedGarageTexture.mapping =
	// 	THREE.EquirectangularReflectionMapping;
	// EXPLAIN: but setting this mapping works
	environmentMapAbandonedGarageTexture.mapping =
	...
	// EXPLAIN: PCFSoftShadowMap is deprecated so we are using
