...
async function init() {
	...
	// EXPLAIN: Why we use Timer instead of Clock
	const timer = new THREE.Timer();

	// EXPLAIN: On line bellow should I use tick() or
	//  window.requestAnimationFrame(tick) and why?
	// EXPLAIN: is something being passed to tick since tick
	// has parameter now
	...
	function tick(timestamp: number) {
		// EXPLAIN: why we update like this
		...
		// EXPLAIN: what kind of math we used here and do you
